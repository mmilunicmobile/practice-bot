...
public class Robot extends TimedRobot {
  ...
  private JoystickButton leftThumbButton = new JoystickButton(leftJoystick, 3);
  ...
  public boolean chamberSensorActive() {
    return chamberSensor.getValue() < 50;
  }

  public boolean conveyorSensorActive() {
    return conveyorSensor.getValue() < 50;
  }

  public void runBalltrack() {
    if (conveyorSensorActive() && chamberSensorActive()) {
      chamberMotor.stopMotor();
      conveyorMotor.stopMotor();
    } else if (chamberSensorActive()) {
